                        ...
                        <div class="shop-p">
                            ...
                            <div class="u-s-p-y-60">
                                ...
                                <div class="shop-p__pagination">
                                    <!--====== Show More Button ======-->
                                    <button id="show-more-btn" class="btn btn--e-transparent-hover-brand-b-2">Show More</button>
                                        ...
                                        <li class="has-list">
                                            ...
                                            <ul style="display:block">
                                                <li class="has-list">
                                                    ...
                                                    <a href="product?category=Chairs">Seating</a>

                                                    <span class="js-shop-category-span fas fa-plus u-s-m-l-6"></span>
                                                    <ul>
                                                        <li>

                                                            <a href="product?subcategory=Armchairs">Armchairs</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Sofas">Sofas</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Benches">Benches</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Stools">Stools</a></li>
                                                    </ul>
                                                </li>
                                                <li class="has-list">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            ...
                                                            <a href="product?subcategory=Dining+Tables">Dining Tables</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Coffee+Tables">Coffee Tables</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Side+Tables">Side Tables</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Bedside+Tables">Bedside Tables</a></li>
                                                    </ul>
                                                </li>
                                                <li class="has-list">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            ...
                                                            <a href="product?subcategory=Wardrobes">Wardrobes</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Cabinets">Cabinets</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Dressers">Dressers</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Bookcases">Bookcases</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Shelving+Units">Shelving Units</a></li>
                                                    </ul>
                                                </li>
                                                <li class="has-list">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            ...
                                                            <a href="product?subcategory=Bed+Frames">Bed Frames</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Mattresses">Mattresses</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Nightstands">Nightstands</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Bunk+Beds">Bunk Beds</a></li>
                                                    </ul>
                                                </li>
                                                <li class="has-list">

                                                    <a href="product?category=Desks">Desks & Workstations</a>

                                                    <span class="js-shop-category-span fas fa-plus u-s-m-l-6"></span>
                                                    <ul>
                                                        <li>

                                                            <a href="product?subcategory=Writing+Desks">Writing Desks</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Computer+Desks">Computer Desks</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Office+Chairs">Office Chairs</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Filing+Cabinets">Filing Cabinets</a></li>
                                                    </ul>
                                                </li>
                                                <li class="has-list">

                                                    <a href="product?category=Dining">Dining Room</a>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="product?subcategory=Dining+Sets">Dining Sets</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Buffets">Buffets</a></li>
                                                    </ul>
                                                </li>
                                                <li class="has-list">

                                                    <a href="#">Children's Furniture</a>

                                                    <span class="js-shop-category-span fas fa-plus u-s-m-l-6"></span>
                                                    <ul>
                                                        <li>

                                                            <a href="product?subcategory=Cribs">Cribs</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Kid+Beds">Kid Beds</a></li>
                                                        <li>

                                                            <a href="product?subcategory=Study+Desks">Study Desks</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
